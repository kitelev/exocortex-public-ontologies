...
|--------|-------|------------|----------|
| Total Classes | 1,574 | - | - |
| Classes with label | 1,368 | 86.9% | ████████░░ |
| Classes with comment | 1,353 | 86.0% | ████████░░ |
...
- ⚠️ `190c48bc`: Class missing rdfs:label
- ⚠️ `16f99ad1`: Class missing rdfs:label
- ⚠️ `80fa0681`: Class missing rdfs:label
- ⚠️ `b9f53685`: Class missing rdfs:label
- ⚠️ `beebe521`: Class missing rdfs:label
- ⚠️ `fe4af75d`: Class missing rdfs:label
- ⚠️ `ecac7e97`: Class missing rdfs:label
- ⚠️ `0cb37b3b`: Class missing rdfs:label
- ⚠️ `e3c847e6`: Class missing rdfs:label
...
- ⚠️ `dolce:amount-of-matter`: Class missing rdfs:label
- ⚠️ `dolce:endurant`: Class missing rdfs:label
- ⚠️ `dolce:state`: Class missing rdfs:label
- ⚠️ `dolce:process`: Class missing rdfs:label
- ⚠️ `dolce:physical-endurant`: Class missing rdfs:label
...
- ⚠️ `geosparql:sfWithin`: Property missing rdfs:label
- ⚠️ `geosparql:rcc8ntpp`: Property missing rdfs:label
...
- ⚠️ `geosparql:asGML`: Property missing rdfs:label
