...
| Source ↓ / Target → | adms | as | dc | dcam | dcat | dcterms | doap | foaf | geo | geosparql | grddl | org | owl | prov | qudt | rdf | rdfs | schema | sh | sioc | skos | sosa | time | vann | vcard | void | vs | xsd |
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|
